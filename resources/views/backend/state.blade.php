	...
	<div class="pagetitle">
	    ...
	    <nav>
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active">{{ __("All States")}}</li>
	        </ol>
	    </nav>
	</div>
	<!-- End Page Title -->
	            ...
	            <form class="row g-3">
		            ...
		            <div class="modal-body">
					    ...
					    <div class="col-12 mt-3">
					        <label for="inputName" class="form-label">{{ __("Country")}}</label>
					        <select class="form-control select2" name="countryid" id="inputCountryid">
                            </select>

                            <span class="err_countryid error d-block text-danger"></span>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistStates') }}",
                columns: [
            ...
            $("#showModal").on('submit','#addForm',function(e){
                ...
                $.ajax({
                    ...
                    success: (data) => { 
                        ...
                        $('.err_countryid').remove();
                        $('#inputCountryid').removeClass('border border-danger');
                    ...
                    error: function(error){
                        ...
                        $.each(err, function( key, value ) {
                            ...
                            if (key == "countryid") 
                            {
                                $('.err_countryid').html(err[key]);
                                $('#inputCountryid').addClass('border border-danger');
                            }
            ...
            $('tbody').on('click', '.editBtn', function (){
                ...
                $('#inputId').val(id);
                $('#inputName').val(name);
            	$('#inputCountryid').val(countryid).trigger('change');
            ...
            $("#showModal").on('submit','#editForm',function(e){
                ...
                var url="{{route('master.state.update',':id')}}";
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                var url="{{route('master.state.destroy',':id')}}";
                url=url.replace(':id',id);
