	...
	<div class="pagetitle">
	    ...
	    <nav>
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active">{{ __("All Religions")}}</li>
	        </ol>
	    </nav>
	</div>
	<!-- End Page Title -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistReligions') }}",
                columns: [
            ...
            $("#showModal").on('submit','#addForm',function(e){
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ route('master.religion.store')}}",
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,
            ...
            $("#showModal").on('submit','#editForm',function(e){
                ...
                var url="{{route('master.religion.update',':id')}}";
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                var url="{{route('master.religion.destroy',':id')}}";
                url=url.replace(':id',id);
