	...
	<div class="pagetitle">
	    ...
	    <nav>
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active">{{ __("Add New Lesson")}}</li>
	        </ol>
	    </nav>
	</div>
	    ...
	    <div class="row">
	        <div class="col-lg-12">
	        	<div class="card">
	                ...
	                <form class="new-added-form" action="{{ route('master.lesson.store')}}" enctype="multipart/form-data" method="POST">
		            @csrf
