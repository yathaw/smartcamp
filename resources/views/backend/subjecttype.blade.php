<x-template>
	...
	<div class="pagetitle">
	    <h1> {{ __("Subjecttype")}}</h1>
	    <nav>
	        <ol class="breadcrumb">
	            <li class="breadcrumb-item"><a href="">{{ __("Dashboard")}}</a></li>
	            <li class="breadcrumb-item active">{{ __("All Subjecttypes")}}</li>
	        </ol>
	    </nav>
	</div>
	                    ...
	                    <table class="table datatable" id="table_id">
	                        <thead>
	                            <tr>
                                    ...
                                    <th scope="col">{{ __("Other Language")}}</th>
            ...
            <div class="container">
	            <form class="row g-3">
		            ...
		            <div class="modal-body">
                        ...
                        <div class="col-12 mb-3">
                            <label for="inputOthername" class="form-label">{{ __("Other Language")}}</label>
                            <input type="text" class="form-control" id="inputOthername" name="othername">

                            <span class="err_othername error d-block text-danger"></span>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if (currentLanguage == "mm") {
            	...
            	var d_cancel_text = "Ihre Daten wurden in unserer Datensubjecttype gespeichert!";
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistSubjecttypes') }}",
                columns: [
            ...
            $("#showModal").on('submit','#addForm',function(e){
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ route('master.subjecttype.store')}}",
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,
                    ...
                    error: function(error){
                        ...
                        $.each(err, function( key, value ) {
                            ...
                            if (key == "othername") 
                            {
                                $('.err_othername').html(err[key]);
                                $('#inputOthername').addClass('border border-danger');
                            }
            ...
            $('tbody').on('click', '.editBtn', function (){
                ...
                var othername = $(this).data('othername');
            ...
            $("#showModal").on('submit','#editForm',function(e){
                ...
                var url="{{route('master.subjecttype.update',':id')}}";
                ...
                $.ajax({
                    ...
                    success: (data) => { 
                        ...
                        $('.err_othername').remove();
                        $('#inputOthername').removeClass('border border-danger');
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                var url="{{route('master.subjecttype.destroy',':id')}}";
                url=url.replace(':id',id);
