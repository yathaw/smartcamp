	            ...
	            <form class="row g-3">
		            ...
		            <div class="modal-body">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <span class="err_date error d-block text-danger"></span>
...
@section('script_content')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            const date_datepicker = new Datepicker(date, {
                autohide: true,
                'format': 'dd MM yyyy',
                title: 'Holiday Date (dd MM yyyy)',
            }); 
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistHolidays') }}",
                columns: [
            ...
            $("#showModal").on('submit','#addForm',function(e){
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ route('master.holiday.store')}}",
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,
            ...
            $("#showModal").on('submit','#editForm',function(e){
                ...
                var url="{{route('master.holiday.update',':id')}}";
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                var url="{{route('master.holiday.destroy',':id')}}";
                url=url.replace(':id',id);
