	...
	<div class="pagetitle">
	    ...
	    <nav>
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active">{{ __("All Banks")}}</li>
	        </ol>
	    </nav>
	</div>
	<!-- End Page Title -->
            ...
            <div class="container">
	            <form class="row g-3">
		            ...
		            <div class="modal-body">
                        ...
                        <div class="col-12 mb-3">
                            <label for="imageUpload" class="form-label">{{ __("Image Upload")}}</label>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistBanks') }}",
                columns: [
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                var url="{{route('master.bank.destroy',':id')}}";
                url=url.replace(':id',id);
