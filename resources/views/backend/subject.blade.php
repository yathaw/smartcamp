	...
	<div class="pagetitle">
	    ...
	    <nav>
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active">{{ __("All Subjects")}}</li>
	        </ol>
	    </nav>
	</div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistSubjects') }}",
                columns: [
            ...
            $("#showModal").on('submit','#addForm',function(e){
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ route('master.subject.store')}}",
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,
            ...
            $("#showModal").on('submit','#editForm',function(e){
                ...
                var url="{{route('master.subject.update',':id')}}";
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                var url="{{route('master.subject.destroy',':id')}}";
                url=url.replace(':id',id);
