	...
	<div class="pagetitle">
	    ...
	    <nav>
	        <ol class="breadcrumb">
	            ...
	            <li class="breadcrumb-item active">{{ __("All Grades")}}</li>
	        </ol>
	    </nav>
	</div>
	<!-- End Page Title -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistGrades') }}",
                columns: [
            ...
            $("#showModal").on('submit','#editForm',function(e){
                ...
                var url="{{route('master.grade.update',':id')}}";
            ...
            $('tbody').on('click', '.deleteBtn', function () {
                ...
                var url="{{route('master.grade.destroy',':id')}}";
                url=url.replace(':id',id);
