<div class="btn-group position-absolute top-0 end-0 ">
        ...
        <ul class="dropdown-menu pb-0 ">
            ...
            <li class="dropdown-item">
                <a href="{{route('lang','en')}}" class="align-items-center text-decoration-none text-dark">
                    ...
                    <p class="ms-2 my-auto d-inline-block">{{ __("English")}}</p>
                </a>
            </li>
            <li>
                <hr class="dropdown-divider">
            ...
            <li class="dropdown-item">
                <a href="{{route('lang','mm')}}" class="align-items-center text-decoration-none text-dark">
                    <svg width="35" height="35" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <p class="ms-2 my-auto d-inline-block">{{ __("Myanmar")}}</p>
                </a>
            </li>
            <li>
                <hr class="dropdown-divider">
            ...
            <li class="dropdown-item">
                <a href="{{route('lang','jp')}}" class="align-items-center text-decoration-none text-dark">
                    ...
                    <p class="ms-2 my-auto d-inline-block">{{ __("Japan")}}</p>
                </a>
            </li>
            <li>
                <hr class="dropdown-divider">
            ...
            <li class="dropdown-item">
                <a href="{{route('lang','cn')}}" class="align-items-center text-decoration-none text-dark">
                    <svg width="35" height="35" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
                    ...
                    <p class="ms-2 my-auto d-inline-block">{{ __("China")}}</p>
                </a>
            </li>
            <li>
                <hr class="dropdown-divider">
            ...
            <li class="dropdown-item">
                <a href="{{route('lang','de')}}" class="align-items-center text-decoration-none text-dark">
                    <svg width="35" height="35" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
                    ...
                    <p class="ms-2 my-auto d-inline-block">{{ __("Germany")}}</p>
                </a>
            </li>
            <li>
                <hr class="dropdown-divider">
            ...
            <li class="dropdown-item mb-0">
                <a href="{{route('lang','fr')}}" class="align-items-center text-decoration-none text-dark">
                    <svg width="35" height="35" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <p class="ms-2 my-auto d-inline-block">{{ __("France")}}</p>
                </a>
            </li>
        </ul>
    </div>