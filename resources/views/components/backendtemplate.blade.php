...
<head>
    ...
    <!-- Normalize CSS -->
    <link rel="stylesheet" href="{{ asset('plugin/font.css') }}">
    <!-- Normalize CSS -->
    <link rel="stylesheet" href="{{ asset('backend/css/normalize.css') }}">
    <!-- Main CSS -->
    <link rel="stylesheet" href="{{ asset('backend/css/main.css') }}">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('plugin/bootstrap5/css/bootstrap.min.css') }}">
    <!-- Fontawesome CSS -->
        ...
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            <div class="nav-bar-header-one">
                <div class="header-logo">
                    <a href="index.html">
                        <img src="{{ asset('logo/logo_white.png') }}" alt="logo" >
                    </a>
                </div>
            ...
            <div class="d-md-none mobile-nav-bar">
               <button class="navbar-toggler pulse-animation" type="button" data-bs-toggle="collapse" data-bs-target="#mobile-navbar" aria-expanded="false">
            ...
            <div class="header-main-menu collapse navbar-collapse" id="mobile-navbar">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="navbar-item dropdown header-message">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-img author-online">
                    ...
                    <li class="navbar-item dropdown header-notification">
                        <a class="navbar-nav-link dropdown-toggle" href="#"  role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="far fa-bell"></i>
                            <div class="item-title d-md-none text-16 mg-l-10">Notification</div>
                            <span>8</span>
                        </a>

                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start" aria-labelled>
                            <div class="item-header">
                    ...
                    <li class="nav-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#"  role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="dashboard-page-one">
           ...
           <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
               <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{ asset('logo/logo_white.png') }}" alt="logo"></a>
                    </div>
               </div>
